...
export const DEFAULT_ALGORITHM_CONFIG: AlgorithmConfig = {
  vitalRiskTerms: {
    medico: [
      ...
      "sobredosis", "ahogando", "se ahoga", "ahogandose",
      "electrocutado", "electrocucion", "intoxicacion", "sin pulso",
      "se muere", "muriendo", "agoniza",
    ],
    seguridad: [
      "tiroteo", "disparos", "disparo", "tiro", "baleado", "balacera",
      "apunalado", "apunalada", "apunalando", "punalada", "acuchillado",
      "navajazo", "asalto armado", "secuestro", "rehen", "rehenes",
      "amenaza de bomba", "explosion", "arma de fuego", "robo a mano armada",
    ],
    desastre: [
      "incendio", "incendia", "incendiando", "incendiado", "en llamas",
      "se prende fuego", "prendio fuego", "derrumbe", "colapso",
      "edificio colapsado", "inundacion grave", "escape de gas", "fuga de gas",
      "atrapado", "atrapada", "atrapados", "atrapadas",
      "persona atrapada", "personas atrapadas", "derrumbe de edificio",
    ],
  },
  emergencyNumbers: {
    medico: ["107", "911"],
